(ns sixsq.slipstream.scui.main.db
  (:require
    [cljs.spec :as s]
...
(def check-spec-interceptor (after (partial check-and-throw :sixsq.slipstream.scui.main.db/db)))
...
(s/def ::scui (s/keys :req-un [::cimi-filter ::page ::page-size]))
