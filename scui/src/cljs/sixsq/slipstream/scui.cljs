(ns sixsq.slipstream.scui
  (:require
    ...
    [sixsq.slipstream.scui.main.events]
    [sixsq.slipstream.scui.main.subs]
    [sixsq.slipstream.scui.main.views]))
...
;;
;; {:compiler-options {:closure-defines {'sixsq.slipstream.scui/DEV false}}
;;
...
;;
;; {:compiler-options {:closure-defines {'sixsq.slipstream.scui/HOST_URL false}}
;;
...
(defn ^:export init
  ...
  (reagent/render [sixsq.slipstream.scui.main.views/app]
