...
(deftask production []
         (task-options! cljs {:optimizations    :advanced
                              :compiler-options {:language-in     :ecmascript5
                                                 :closure-defines {'sixsq.slipstream.scui/DEV false
                                                                   'goog.DEBUG                 false}}})
         identity)
...
(deftask development []
         (task-options! cljs {:optimizations    :none
                              :source-map       true
                              :compiler-options {:language-in     :ecmascript5
                                                 :closure-defines {'sixsq.slipstream.scui/DEV      true
                                                                   'sixsq.slipstream.scui/HOST_URL "https://nuv.la"
                                                                   'goog.DEBUG                      true}}}
                        reload {:on-jsload 'sixsq.slipstream.scui/init})
         identity)
