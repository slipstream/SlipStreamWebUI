...
(def dictionary
  {:en {:lang                     "english"
        ...
        :documentation-intro      "Welcome to the API documentation. It has been designed to be comprehensive, covering all resources, and portable, allowing access from any programming language."
        :download                 "download"
        :drop-file                "drop file"
        :edit                     "edit"
        :editing                  "editing"
        ...
        :select-datasets          "click on cards to select dataset(s)"
   ...
   :fr {:lang                   "français"
        ...
        :details                "détails"
        :documentation          "api documentation"
        :documentation-intro     "Bienvenue sur la documentation de l'API. Elle a été conçue pour etre lisible, exhaustive, et portable, accessible depuis n'importe quel langage de programmation."
        ...
        :select-datasets        "cliquez sur les cartes pour selectionner les collections de données"
