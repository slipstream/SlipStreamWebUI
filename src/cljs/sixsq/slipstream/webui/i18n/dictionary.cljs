...
(def dictionary
  {:en {:lang                     "english"
        ...
        :reset-password-inst      "Enter your username to reset your pasword. We'll send an email with instructions."
        ...
        :vms                      "VMs"
        :welcome                  "welcome"
        :welcome-cimi-desc        "Understand the details with the CIMI API."
   ...
   :fr {:lang                "français"
        ...
        :vms                 "VMs"
        :welcome             "bienvenue"
        :welcome-cimi-desc   "Comprendre les détails avec l'API CIMI."
