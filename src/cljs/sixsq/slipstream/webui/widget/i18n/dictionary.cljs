...
(def dictionary
  {:en {:lang "english"
        ...
        :delete-resource-msg "delete resource %1? This action cannot be undone."
        :deployment "deployment"
        :editing "editing"
        :empty "."
        :error "error"
        :execute-action "execute action %1?"
        :execute-action-msg "execute action %1 for the resource %2?"
        :fields "fields"
        :filter "filter"
        :first "first"
        :home "home"
   ...
   :fr {:lang "français"
        ...
        :delete-resource-msg "Supprimer la ressource %1? Cet action ne peut pas être annuler."
        :deployment "déploiement"
        :editing "edition"
        :empty "."
        :error "erreur"
        :execute-action "exécuter l'action %1?"
        :execute-action-msg "exécuter l'action %1 pour la ressource %2?"
        :fields "champs"
        :filter "filtre"
        :first "premier"
        :home "chez moi"
