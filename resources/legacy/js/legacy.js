...
document.write("<script>if (typeof goog != \"undefined\") { goog.require(\"figwheel.connect.build_dev_legacy\"); }</script>");
document.write('<script>goog.require("sixsq.slipstream.legacy.components");</script>');